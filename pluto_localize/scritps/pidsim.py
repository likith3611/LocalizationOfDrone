...
class DroneFly():
    ...
    def __init__(self):
        ...
        rospy.Subscriber('setspecs/pose', Point, self.get_pose)
    ...
    def pid_roll(self):
        ...
        self.P_value_roll = 1271 * self.error_roll
        self.D_value_roll = 4744 * ( self.error_roll - self.DerivatorR)
    ...
    def pid_pitch(self):
        ...
        self.P_value_pitch = 694 * self.error_pitch
        self.D_value_pitch = 2297 * ( self.error_pitch - self.DerivatorP)
    ...
    def pid_throt(self):
        ...
        self.P_value_throt = 1175   * self.error_throt
        self.D_value_throt = 42000 * ( self.error_throt - self.DerivatorT)
